              ...
              >
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    {course.status === COURSE_STATUS.DRAFT ? (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-slate-700 px-2 py-[2px] text-[12px] font-medium text-pink-100">
                        <HiClock size={14} />
                        Drafted
                      </p>
                    ) : (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-slate-700 px-2 py-[2px] text-[12px] font-medium text-yellow-100">
                ...
                <Td className="text-sm font-medium text-slate-100 ">
                  <button
                    ...
                    title="Edit"
                    className="px-2 transition-all duration-200 hover:scale-110 hover:text-green-300"
                  >
                    <FiEdit2 size={20} />
                  </button>
                  <button
